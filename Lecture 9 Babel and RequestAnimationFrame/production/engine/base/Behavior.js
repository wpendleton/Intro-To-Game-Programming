...
var Behavior = /*#__PURE__*/function (_Component) {
  _inherits(Behavior, _Component);
  ...
  _createClass(Behavior, [{
    ...
    value: function start() {} //Just a reminder that extending classes should have an update() function
