...
var collisionScene = Engine.Base.Scene.parse(Scenes.CollisionScene);
var sceneOne = Engine.Base.Scene.parse(Scenes.SceneOne);
var sceneTwo = Engine.Base.Scene.parse(Scenes.SceneTwo);
var sceneTwoB = Engine.Base.Scene.parse(Scenes.SceneTwoB);
var sceneStrategyScene = Engine.Base.Scene.parse(Scenes.StrategyScene);
var roomScene = Engine.Base.Scene.parse(Scenes.RoomScene);
